...
Can filter out outliers if needed, but for now I will not.

<!--  ```{r } -->
<!--   physeq.filtered <- prune_samples(!(sample_names(physeq.filtered) %in% c("MB4", "MB5")), physeq.filtered) -->
<!--   physeq.filtered -->
<!--  ``` -->
...
We do not have background/negative controls in this experiment therefore can't do this step.  
...
p <-plot_tree(ex0, label.tips = 'Family',
          ladderize = "left",
          justify = "left",
          color = 'Treatment'
          )
