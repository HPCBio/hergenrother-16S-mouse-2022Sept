...
A steep increase in unassigned ranks from Order to Genus. If we stick to family we retain most information.  If we choose taxonomic agglomeration, I'll likely agglomerate to Order or Family simply due to the resolution, but we can revisit.
...
<!--  #Skipping the removal of NA phyla -->
...
This retains the vast majority of data (~99% or so), so this seems like a reasonable cutoff. I could even increase the prevalence threshold to 0.1  (present in 10 samples) and that still retains the majority of counts except for one Clindamyacin sample. I'll stick with 0.05, but we can increase this later if you'd like.
